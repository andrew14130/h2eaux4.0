...
class FicheChantier(BaseModel):
    ...
    # Onglet 1: Général
    date_rdv: str = ""
    type_intervention: str = "visite_technique"  # visite_technique, releve_existant, installation, maintenance
    statut: str = "planifie"  # planifie, en_cours, termine, valide
    ...
    # Onglet 3: Logement
    type_logement: str = "maison"  # maison, appartement, studio
    annee_construction: int = 2000
    surface: str = ""
    isolation: str = "moyenne"  # faible, moyenne, bonne, rt2012
    menuiseries: str = "double"  # simple, double, triple
    
    # Onglet 4: Existant
    chauffage_actuel: str = ""
    etat_general: str = "bon"  # bon, moyen, mauvais, vetuste
    production_ecs: str = "chaudiere"  # chaudiere, ballon_electrique, chauffe_eau_gaz, solaire, aucune
    observations_existant: str = ""
    
    # Onglet 5: Besoins
    besoins: str = ""  # JSON string des besoins cochés
    priorite: str = "moyenne"  # haute, moyenne, basse
    delai_souhaite: str = "moyen"  # immediat, court, moyen, long
    contraintes: str = ""
    
    # Onglet 6: Technique
    compteur_electrique: str = ""
    arrivee_gaz: str = "non"  # oui, non, proche
    evacuation_eaux: str = ""
    acces_materiel: str = "facile"  # facile, moyen, difficile, impossible
    contraintes_techniques: str = ""
    
    # Onglet 7: Plan 2D
    plan_data: str = ""  # JSON string du plan 2D
