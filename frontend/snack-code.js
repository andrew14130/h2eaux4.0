// COPIEZ CE CODE DANS EXPO SNACK (snack.expo.dev)
// PUIS SCANNEZ LE QR CODE AVEC EXPO GO SUR VOTRE TABLETTE
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView contentContainerStyle={styles.loginContainer}>
          <View style={styles.logoSection}>
            ...
            <Text style={styles.versionText}>Application Android Native v1.0</Text>
          </View>
          ...
          <View style={styles.testSection}>
            <Text style={styles.testTitle}>📱 Test sur Tablette Android</Text>
            <Text style={styles.testText}>Interface tactile optimisée</Text>
            <Text style={styles.testText}>Compatible smartphone & tablette</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    );
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView style={styles.modulesContainer} showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.statusSection}>
            ...
            <Text style={styles.statusItem}>📱 Test Expo Go réussi</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    );
